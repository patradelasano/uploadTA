...
if($op=='kode'){
    ...
    $kd=$_GET['kd'];
    $sql=mysql_query("select * from tblkamar where kode='$kd'");
    ...
    $update=mysql_query("update tblkamar set nama='$nama',
                        hrg_beli='$beli',
                        hrg_jual='$jual',
                        stok='$stok'
                        where kode='$kode'");
    ...
    $kode=$_GET['kode'];
    $del=mysql_query("delete from tblkamar where kode='$kode'");
    if($del){
        echo "sukses";
    }else{
        echo "ERROR";
    ...
    $tambah=mysql_query("insert into tblkamar (kode,nama,hrg_beli,hrg_jual,stok)
